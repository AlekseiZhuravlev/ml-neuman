...
class NeumanDataset(torch.utils.data.Dataset):
    def __init__(self, exp_dir, cap_ids):
        ...
        dataset_size = 30
        # replicate self.camera_params_opencv
        self.camera_params_opencv = self.camera_params_opencv * dataset_size
        self.images *= dataset_size
        self.silhouettes *= dataset_size
        self.manos *= dataset_size
        print(len(self.camera_params_opencv))
